...
assert_contains "$HOME/.codex/hooks.json" "--host codex --target claude"
assert_contains "$HOME/.codex/hooks.json" ".cc-suite/bin/cc-suite-dispatch-hook"
assert_contains "$HOME/.claude/settings.json" "--host claude --target codex"
assert_no_file ".claude/settings.local.json"
assert_no_file ".cc-suite/project.json"
