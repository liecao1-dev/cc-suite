...
//
// bridge_skills.sh exposes the explicit `$claude` dispatcher directly under
...
export const CLAUDE_DELEGATION_BOUNDARY = [
  ...
  "Do not invoke the /codex workspace skill or otherwise hand the task back to Codex.",
  INVARIANT_NO_RETURN_TO_AUTHOR,
].join(" ");
